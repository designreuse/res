						...
						<form class="horizontal-form"  action="/limits/saveData"  method="post">
							<div class="form-body">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="form-group ">
											<label class="control-label">权限类型(<font class='hongxin'>*</font>)</label> 
											<select  name="type"  id="type"    valType="required" 
												class="form-control">
								...
								<div  class="row">
								       <div class="col-sm-6">
										<div class="form-group "  style="display: none;">
											...
											<input  type="text"    name="parent_id"  class="form-control"  value="<%=qxId%>" />
										</div>
									</div>
								</div>
								<div class="row">
