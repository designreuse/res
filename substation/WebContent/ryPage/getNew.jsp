						...
						<form class="horizontal-form"  action="/user/add"  method="post"  name="normal" >
							<div class="form-body"  >
								...
								<div class="row">
								   <div class="col-sm-6">
										<div class="form-group">
											<label class="control-label">密码(<font class='hongxin'>*</font>)</label> <input type="password"  name="password"   valType="required" 
												onblur="validateVal(this);"  class="form-control"  placeholder="请输入密码"   value="123456">
											<span class="help-block"  style="display:none">
														密码不能为空. </span>
										    <input name="isSetPassword"  type="hidden"   value="1">
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
