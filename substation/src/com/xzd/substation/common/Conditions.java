...
public class Conditions {
    ...
    public void setFiledQuery(String QueryType, String... filedName) {
        if (StringUtils.isNotBlank(QueryType) && filedName!=null&& filedName.length>0) {
    ...
    public void setValueQuery(String QueryType, String fieldName, Object filedValue) {
        if (StringUtils.isNotBlank(QueryType) && StringUtils.isNotBlank(fieldName) && filedValue!=null) {
    ...
    public void modelToCondition(Model<?> modelClass, String alias) {
        ...
        if (modelClass != null) {
            ...
            // 字段名和值的map集合
            Map<String, Object> valueMap =modelToMap(modelClass);
    ...
    public void recordToCondition(Record recordClass, String alias) {
        ...
        if (recordClass != null) {
            ...
            // 字段名和值的map集合
            Map<String, Object> valueMap =recordToMap(recordClass);
    ...
    private void buildSQL(StringBuilder sb, String queryType, String fieldName, Object fieldValue, String alias, ArrayList<Object> params) {
        // 非空的时候进行设置
        if (fieldValue!=null &&StringUtils.isNotEmpty(fieldName)) {
    ...
    public Map  modelToMap(Model modelClass){
	   Map valueMap = new HashMap(); 
	   Set<Entry> set=modelClass.getAttrsEntrySet();
	 ...
	 public Map recordToMap(Record recordClass){
	    Map valueMap = recordClass.getColumns(); 
        return valueMap;
	 }
